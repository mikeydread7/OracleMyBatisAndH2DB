...
public class RESTFulHelperTest  {
	...
	public void testRestFullHelperISODATE() throws JsonProcessingException {
		assertTrue(RESTFulHelper.getISOTimeStamp(MockListOfUsers.mockEntityUserList.get(2).getBirthday()).contains("Z"));
	}

	@Test
	public void testRestFullHelperGotGoodJSON() throws JsonProcessingException {
		assertTrue(ValidateInput.jsonCanBeTrusted(RESTFulHelper.getJsonLikeString(MockListOfUsers.mockEntityUserList.get(3))));
	}
}
